...
quantity = []
price = []
Actions.take_details_from_pop_up_cart(driver, names, colors, quantity, price)

Main_Page(driver).click_cart()

deleted_product_name = [driver.find_element_by_css_selector("h3[class='ng-binding']").text]
Cart_Page(driver).remove_product_from_cart(2)
...
quantity2 = []
price2 = []
Actions.take_details_from_pop_up_cart(driver, names2, colors2, quantity2, price2)
